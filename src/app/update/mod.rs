...
impl App {
    ...
    pub fn update(&mut self, message: Message, event_tx: crate::app::EventSender) {
        match message {
    ...
    fn handle_service_action(&mut self, action: ServiceAction, event_tx: crate::app::EventSender) {
        match action {
            ...
            ServiceAction::Sqs(action) => self.handle_sqs_action(action, event_tx),
        }
    }
}
